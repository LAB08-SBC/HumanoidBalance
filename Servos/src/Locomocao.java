...
public class Locomocao {
	...
	public static int initPos[] = { 336, 687, 298, 724, 412, 611, 355, 664,
			491, 530, 394, 625, 278, 743, 616, 405, 490, 530 };
	...
	static Bioloid jason = new Bioloid(18);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		while (teste) {
			...
			while (i.doubleValue() < 14.7) {
				...
				int motor9 = (int) (-0.000275921606029018
				...
				int motor10 = (int) (-0.000140124106979082
				...
				int motor11 = (int) (0.00000140489885303541
						* (Math.pow(i.doubleValue(), 12))
						- 0.000137098037479588
						* (Math.pow(i.doubleValue(), 11)) + 0.00593962266650624
						* (Math.pow(i.doubleValue(), 10)) - 0.150467310047963
						* (Math.pow(i.doubleValue(), 9)) + 2.47028882826084
						* (Math.pow(i.doubleValue(), 8)) - 27.5207922276621
						* (Math.pow(i.doubleValue(), 7)) + 211.699439008591
						* (Math.pow(i.doubleValue(), 6)) - 1121.79501433143
						* (Math.pow(i.doubleValue(), 5)) + 4012.95422656784
						* (Math.pow(i.doubleValue(), 4)) - 9303.65422686671
						* (Math.pow(i.doubleValue(), 3)) + 13044.0770540131
						* (Math.pow(i.doubleValue(), 2)) - 9823.0075743571
						* i.doubleValue() + 3401.38059312374);
				int motor12 = (int) (0.00000011672084327608
						* (Math.pow(i.doubleValue(), 14))
						- 0.000012662080312946
						* (Math.pow(i.doubleValue(), 13))
						+ 0.000615851466539234
						* (Math.pow(i.doubleValue(), 12)) - 0.017737457506048
						* (Math.pow(i.doubleValue(), 11)) + 0.336649535916704
						* (Math.pow(i.doubleValue(), 10)) - 4.43504476680317
						* (Math.pow(i.doubleValue(), 9)) + 41.6304852819428
						* (Math.pow(i.doubleValue(), 8)) - 281.48687768283
						* (Math.pow(i.doubleValue(), 7)) + 1370.97665082275
						* (Math.pow(i.doubleValue(), 6)) - 4763.85605618472
						* (Math.pow(i.doubleValue(), 5)) + 11574.9816970237
						* (Math.pow(i.doubleValue(), 4)) - 18997.7828225834
						* (Math.pow(i.doubleValue(), 3)) + 19842.4241425091
						* (Math.pow(i.doubleValue(), 2)) - 11754.8617513084
						* i.doubleValue() + 3597.71125928176);
				...
				int motor14 = (int) (0.00000083846544852191
				...
				int motor15 = (int) (0.0000217898674376092
				...
				int motor16 = (int) (0.0000248742798796263
				...
				int motor17 = (int) (-0.000602821242505626
				...
				int motor18 = (int) (-0.00021958932773343
				...
				System.out.println(motor9);
				System.out.println(motor10);
				System.out.println(motor11);
				System.out.println(motor12);
				System.out.println(motor13);
				System.out.println(motor14);
				System.out.println(motor15);
				System.out.println(motor16);
				System.out.println(motor17);
				System.out.println(motor18);
			}
			//teste = false;
			// 449 09
			// 474 10
			...
			// 336, 687, 298, 724, 412, 611, 355, 664, 491, 530, 394, 625, 278,
			// 743, 616, 405, 490, 530
			// 336, 687, 298, 724, 412, 611, 360, 660, 491, 530, 374, 650, 278,
			// 743, 616, 405, 494, 520
			
			//Somar= movimento em sentido horario
