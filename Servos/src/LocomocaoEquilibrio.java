...
public class LocomocaoEquilibrio
{
    ...
    public static int posicoes[] = {336, 687, 298, 724, 412, 611, 355, 664, 491, 530, 394, 625, 278, 743, 616, 405, 490, 530};
    	...
    	while(teste){
		    ...
		    try{
		    	if(Math.abs(anguloPadrao-LoopbackTest.anguloAtual)>4){
		    		saidas=LocomocaoComFCL.calcularAngulo(LoopbackTest.anguloAtual, velocidade);
